...
> ⚠️ 当前仓库只收录**文档与漫画**部分，`project-python/` / `project-java/` /
> `project-go/` 三个实战项目尚未落地。下表为规划中的技术选型，供参考。
...
> 规划中的 `project-python/` / `project-java/` / `project-go/` 三个实战项目尚未落地，
> 见上文「实战项目（规划中）」。
...
4. 参考 [开源项目学习笔记](docs/03-开源项目学习笔记/README.md) 拆解优秀项目
5. 准备 [简历](docs/04-简历模板/README.md) 和 [面试稿](docs/05-STAR面试稿/README.md)
6. 用 [面试问答集](docs/06-面试问答集/README.md) 模拟面试

### 2. 实战项目

实战项目（Python / Java / Go 三版本）尚未落地。当前可先按
[开源项目学习笔记](docs/03-开源项目学习笔记/README.md) 拆解 Claude Code、ragent
等成熟项目，再参照 [技术架构概览](#技术架构概览) 自行搭建。
